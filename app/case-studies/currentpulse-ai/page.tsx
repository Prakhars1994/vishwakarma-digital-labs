...
const LIVE_URL = "https://cp.vishwakarma-labs.workers.dev/";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "CurrentPulse AI — Full-Stack AI Product Case Study",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-3"><a href={LIVE_URL} target="_blank" rel="noreferrer" className="rounded-xl bg-white px-6 py-3 font-black text-slate-950">Open live product ↗</a><a href={CONTACT.github} target="_blank" rel="noreferrer" className="rounded-xl border border-white/15 px-6 py-3 font-bold">View GitHub profile</a></div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.025] p-8"><div className="text-sm font-black uppercase tracking-wider text-orange-400">Engineering focus</div><h2 className="mt-4 text-3xl font-black">The hard part is the workflow.</h2><ul className="mt-6 space-y-3 leading-7 text-slate-300"><li>✓ separate user-facing reads from heavier background work</li><li>✓ structure content before it reaches public pages</li><li>✓ handle external API failures and quotas</li><li>✓ deduplicate and track processing state</li><li>✓ deploy and iterate on a real production system</li></ul></div>
        </div>
